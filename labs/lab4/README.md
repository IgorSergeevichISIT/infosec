...
***Найденные дорки рекомендуется занести в**  [таблицу]() **(производите вставку дорка через Ctrl+Shift+V или "Специальная вставка"->"Только значения", чтобы не нарушать форматирование таблицы)**
